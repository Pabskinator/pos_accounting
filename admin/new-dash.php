<?php
	...
	$user_member_id = $user->data()->member_id;
	...
	<?php if($user_member_id){
		...
		<div class="container text-center">
			<div class="jumbotron">
				...
				<p><a class='btn btn-primary' href='wh-order.php'>Order Now</a></p>
			</div>
		</div>
	<?php
	} else {
	...
	<div class="row top_titles">
		...
		<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="tile-stats">
				...
				<div class="count"><?php echo $cproducts; ?></div>
		...
		<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="tile-stats">
				...
				<div class="count"><?php echo $cbranch; ?></div>
				<h3><a href="branch.php.php">Branches</a></h3>
				<p>Branch list</p>
			</div>
		</div>
		<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="tile-stats">
				...
				<div class="count"><?php echo $cterminals; ?></div>
				<h3><a href="terminal.php">Terminals</a></h3>
				<p>Terminal list</p>
			</div>
		</div>
		<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="tile-stats">
				...
				<div class="count"><?php echo $cmember; ?></div>
				<h3><a href="members.php.php">Clients</a></h3>
				<p>Client list</p>
			</div>
		</div>
	</div>
							...
							<li>
								<?php
									if($user->hasPermission('r_item')) {
										?>
										<a href='report-item.php'  title='Item Report'>
							...
							<li>
								<?php
									if($user->hasPermission('r_client')) {
										?>
										<a  href='report-member.php'  title='Member Report'>
							...
							<li>
								<?php
									if($user->hasPermission('r_order')) {
										?>
										<a href='report-order.php'  title='Order Report'>
							...
							<li>
								<?php
									if($user->hasPermission('daily_sales')) {
										?>
										<a  href='daily-summary.php'  title='Daily Summary'>
							...
							<li>
								<?php
									if($user->hasPermission('st_sum_sales')) {
										?>
										<a  href='sales-type-summary.php'  title='Sales Type Summary'>
							...
							<li>
								<?php
									if($user->hasPermission('deduction_summary')) {
										?>
										<a href='deduction-summary.php'  title='Deduction Summary'>
							...
							<li>
								<?php
									if($user->hasPermission('r_quota')) {
										?>
										<a  href='branch-quotas.php'  title='Quota Summary'>
							...
							<li>
								<?php
									if($user->hasPermission('r_freebie')) {
										?>
										<a  href='freebie-summary.php'  title='Freebie Report'>

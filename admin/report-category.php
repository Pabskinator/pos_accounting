		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
						...
						<div class="col-md-3">
							<input type="text" class='form-control' name='dt' id='dt' placeholder='Choose Month' autocomplete="off">
						</div>
						<div class="col-md-3">
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('body').on('click','.btnPrint',function(){
				var html = $('.table-responsive').html();
				printWithStyle(html);
			});
			...
			function getCategory(dl){
				...
				if(dl == 1){
					...
					window.open(
						'../ajax/ajax_sales_query.php?functionName=getByCategory&dl='+dl+'&branch_id='+branch_id+'&dt='+dt,
						'_blank' //
					);
					...
					$.ajax({
						...
						data: {functionName:'getByCategory',dl:dl,dt:dt, branch_id:branch_id,},
						success: function(data){
							$('#holder').html(data);
						},
						error:function(){

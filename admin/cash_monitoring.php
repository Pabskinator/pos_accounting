...
?>
	...
	<div class="page-content inset">
		<div class="content-header">
			<h1>
				<span id="menu-toggle" class='glyphicon glyphicon-list'></span> Cash Monitoring </h1>
		...
		$(document).ready(function() {
			...
			function getPage(p){
				...
				$.ajax({
					...
					data:{page:p,dt1:dt1,dt2:dt2,functionName:'cashPaginate',cid: <?php echo $user->data()->company_id; ?>,search:search},
			...
			$('body').on('click','#btnDownloadExcel',function(){
				...
				window.open(
					'excel_downloader.php?downloadName=cashMon&search='+search+'&dt1='+dt1+'&dt2='+dt2,
					'_blank' //
				);
			});

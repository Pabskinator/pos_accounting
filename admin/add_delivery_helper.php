		...
		<div class="page-content inset">
			<div class="content-header">
				<h1>
					...
					<?php echo isset($editid) && !empty($editid) ? "EDIT HELPER" : "ADD HELPER"; ?>
				</h1>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<?php
						...
						if (Input::exists()){
							...
							if(Token::check(Input::get('token'))){
								...
								if(!Input::get('edit')) {
									$additionalvalidation = array('unique' => 'delivery_helpers');
								...
								if($validate->passed()){
									...
									if(Input::get('edit')){
										...
										try{
											...
											Session::flash('flash','Helper information has been successfully updated');
											Redirect::to('delivery_helper.php');
										} catch(Exception $e) {
											die($e->getMessage());
										}
									} else {
										...
										Session::flash('flash','You have successfully added a helper');
										Redirect::to('delivery_helper.php');
									}
								} else {
									$el ='';
					...
					<form class="form-horizontal" action="" method="POST">
						<fieldset>
							...
							<legend>Helper Information</legend>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									...
									<span class="help-block">Name of the delivery helper (Pahinante)</span>
								</div>
							</div>

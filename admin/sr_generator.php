<?php
	...
	$barcode_format = $barcodeClass->getFormat($user->data()->company_id,'SR');

	$by_branch = $barcodeClass->get_format_by_branch($user->data()->branch_id,"SR");
	$has_own_layout = 0;
	...
	<div class="page-content inset">
		...
		<div id="content" >
			<div id='conpage' data-targetid='conpageValue' class="conpage">
				...
				<div data-targetid='terms' class='terms canbedrag'>Model Number</div>
				<div data-targetid='ponum' class='ponum canbedrag'>Serial Number</div>
				<div data-targetid='tin' class='tin canbedrag'>SCS Number</div>
				<div data-targetid='lbl' class='lbl canbedrag'>SAR Number</div>
				</img>
			</div>

<?php
	...
	$barcode_format = $barcodeClass->get_dr_format($user->data()->company_id);

	$by_branch = $barcodeClass->get_format_by_branch($user->data()->branch_id,"DR");
	$has_own_layout = 0;
	if($by_branch){
		$has_own_layout = 1;
				...
				$.ajax({
					...
					success: function(data){
						alertify.alert(data,function(){
							location.href ='dr_generator.php';
						});
					},
					error:function(){

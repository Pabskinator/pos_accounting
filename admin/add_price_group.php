<?php
	...
	if(isset($editid) && !empty($editid)) {
		...
		$price_group = new Price_group($id);
	...
	if (Input::exists()){
		...
		if(Token::check(Input::get('token'))){
			...
			if(!Input::get('edit')) {
				$additionalvalidation = array('unique' => 'price_groups');
		...
		<div class="page-content inset">
			<div class="content-header">
				<h1>
					...
					<?php echo isset($editid) && !empty($editid) ? "EDIT PRICE GROUP" : "ADD PRICE GROUP"; ?>
				</h1>
			</div>
					...
					<form class="form-horizontal" action="" method="POST">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="branchName" name="name" placeholder="Enter Name" class="form-control input-md" type="text" value="<?php echo isset($id) ? escape($price_group->data()->name) : escape(Input::get('name')); ?>">

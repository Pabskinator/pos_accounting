<?php
	...
	$barcode_format = $barcodeClass->get_ir_format($user->data()->company_id);

	$by_branch = $barcodeClass->get_format_by_branch($user->data()->branch_id,"IR");
	$has_own_layout = 0;
	if($by_branch){
		$has_own_layout = 1;
				...
				$.ajax({
					...
					success: function(data){
						alertify.alert(data,function(){
							location.href ='ir_generator.php';
						});
					},
					error:function(){

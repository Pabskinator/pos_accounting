		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-3">
						<input type="text" autocomplete="off" class='form-control' name='dt' id='dt' placeholder='Choose Month'>
					</div>
					<div class="col-md-3">
		...
		$(document).ready(function(){
			...
			function getSummary(dl){
				...
				if(dl == 1){
					...
					window.open(
						'../ajax/ajax_sales_query.php?functionName=getSalesTypeSummary&dl='+dl+'&branch_id='+branch_id+'&dt='+dt+'&date_type='+date_type,
						'_blank' //
					);
					...
					$.ajax({
						...
						data: {functionName:'getSalesTypeSummary',dl:dl,dt:dt, branch_id:branch_id,date_type:date_type},
						success: function(data){
							$('#holder').html(data);
						},
						error:function(){

		...
		<div class="page-content inset">
			<div class="content-header">
				<h1>
					...
					<?php echo isset($editid) && !empty($editid) ? "Edit ".MEMBER_LABEL." Characteristics" : "Add ".MEMBER_LABEL." Characteristics"; ?>
				</h1>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<?php
						...
						if (Input::exists()){
							...
							if(Token::check(Input::get('token'))){
								...
								if(!Input::get('edit')) {
									$additionalvalidation = array('unique' => 'member_characteristics_list');
								...
								if($validate->passed()){
									...
									if(Input::get('edit')){
										...
										try{
											...
											Session::flash('characteristicsflash','Characteristics information has been successfully updated');
											Redirect::to('member_char.php');
										} catch(Exception $e) {
											die($e->getMessage());
										}
									} else {

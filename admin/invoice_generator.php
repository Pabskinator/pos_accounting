<?php
	...
	$barcode_format = $barcodeClass->get_invoice_format($user->data()->company_id);

	$by_branch = $barcodeClass->get_format_by_branch($user->data()->branch_id,"INVOICE");
	$has_own_layout = 0;
		...
		<div class="page-content inset">
			...
			<div id="content" >
				<div id='conpage' data-targetid='conpageValue' class="conpage">
					...
					<div data-targetid='drnum' class='drnum canbedrag'>Invoice</div>
					...
					<div data-targetid='lb2' class='lbl2 canbedrag'>LBL2</div>
				</div>
			</div>
				...
				$.ajax({
					...
					success: function(data){
						alertify.alert(data,function(){
							location.href ='invoice_generator.php';
						});
					},
					error:function(){

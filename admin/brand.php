<?php
	...
	$brandcls = new Brand();
	$brands = $brandcls->get_active('brands',array('company_id' ,'=',$user->data()->company_id));
	$cf = new Custom_field();
...
?>
	...
	<div class="page-content inset">
		...
		<div class="row">
			<div class="col-md-12">
				<?php include 'includes/station_nav.php'; ?> <br>
				<div class="btn-group" role="group" aria-label="..." style='margin-bottom:10px;'>
					<a class='btn btn-default' href='addbrand.php' title='Add Branch'>
						<span class='glyphicon glyphicon-plus'></span>
						<span class='hidden-xs'>Add Brand</span>
					</a>
				</div>
								...
								?>
										<tr>
											...
											<td data-title='Action'>
													<a class='btn btn-primary' href='addbrand.php?edit=<?php echo Encryption::encrypt_decrypt('encrypt',$b->id);?>' title='Edit Brand'><span class='glyphicon glyphicon-pencil'></span></a>
		...
		$(document).ready(function(){
			$(".deleteBrand").click(function(){
				if(confirm("Are you sure you want to delete this record? \n ")){
					var id = $(this).prop('id');
					$.post('../ajax/ajax_delete.php',{id:id,table:'brands'},function(data){
						if(data == "true"){
							location.reload();
						}
					});

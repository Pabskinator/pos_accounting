...
?>
	...
	<div class="page-content inset">
		...
		<?php
			...
			if(Session::exists('deptflash')){
					echo "<br/><div class='alert alert-info' style='width:90%;margin:0 auto'>".Session::flash('deptflash')."</div>";
			}
		...
		<div class="row">
          ...
          <?php 	if($user->hasPermission('department_m')){ ?>
						<div class="btn-group" role="group" aria-label="..." style='margin-bottom:10px;'>
							<a class='btn btn-default' href='adddepartment.php' title='Add Department'>
								<span class='glyphicon glyphicon-plus'></span>
								<span class='hidden-xs'>Add Department</span>
							</a>
						</div>
          <?php } ?>
							...
							<div class="col-md-3">
								<div class="form-group">
									<div class="input-group">
										...
										<input id='search' type="text" class="form-control" placeholder="Search Department" aria-describedby="sizing-addon1">
									</div>
								</div>
							</div>
						</div>
      ...
      $(document).ready(function(){
          ...
          function getPage(p,search){
              $.ajax({
                  ...
                  data:{page:p,functionName:'departmentPaginate',cid: <?php echo $user->data()->company_id; ?>,search:search},

...
?>
	...
	<div class="page-content inset">
		<div class="content-header">
			<h1>
				<span id="menu-toggle" class='glyphicon glyphicon-list'></span>Dicer Bad Order</h1>
		...
		$(document).ready(function() {
			...
			function getPage(p){
				...
				$.ajax({
					...
					data:{functionName:'dicerBO',page:p,cid: <?php echo $user->data()->company_id; ?>,search:search},

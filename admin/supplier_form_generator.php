...
?>
	...
	<style>
		...
		.logo {
			position:absolute;
			top:<?php echo $styles['logo']['top'] . "px" ?>;
			left:<?php echo $styles['logo']['left'] . "px" ?>;
			width: <?php echo $styles['logo']['width'] . "px" ?>;
			height: <?php echo $styles['logo']['height'] . "px" ?>;
			font-size: <?php echo $styles['logo']['fontSize'] . "px" ?>;
			display: <?php echo  ($styles['logo']['visible']) ? 'block' : 'none' ?>;
			font-weight: <?php echo  ($styles['logo']['bold']) ? 'bold' : 'normal' ?>;
		}
		.date {
			position:absolute;
	...
	<div class="page-content inset">
		...
		<div id="content" >
			<div id='conpage' data-targetid='conpageValue' class="conpage">
				...
				<img src='../css/img/logo.jpg' data-targetid='logo'  class='logo canbedrag'>
				<div data-targetid='membername' class='membername canbedrag'>Supplier Name</div>
				<div data-targetid='memberaddress' class='memberaddress canbedrag'>Supplier Address</div>
				<div data-targetid='stationname' class='stationname canbedrag'>Branch Name</div>
				<div data-targetid='stationaddress' class='stationaddress canbedrag'>Branch Address</div>
				...
				<div data-targetid='cashier' class='cashier canbedrag'>Received By</div>
				<div data-targetid='remarks' class='remarks canbedrag'>Remarks</div>
				<div data-targetid='reserved' class='reserved canbedrag'>Requested by</div>
				<div data-targetid='drnum' class='drnum canbedrag'>DR</div>
			...
			<div id="editor" style='padding:10px;'>
				...
				<table class="table">
					...
					<tr >
						<td>Logo</td>
						<td><input type="checkbox" id='logoVisible' <?php echo ($styles['logo']['visible']) ? 'checked' : ''; ?> /></td>
						<td><input type="checkbox" id='logoBold' <?php echo ($styles['logo']['bold']) ? 'checked' : ''; ?> /></td>
						<td><input  class='form-control' type='text' id='logoTop' value='<?php echo $styles['logo']['top']; ?>' /></td>
						<td><input class='form-control' type='text' id='logoLeft' value='<?php echo $styles['logo']['left']; ?>'/></td>
						<td><input  class='form-control'  type='text' id='logoWidth' value='<?php echo $styles['logo']['width']; ?>'/></td>
						<td><input class='form-control'  type='text' id='logoHeight' value="<?php echo $styles['logo']['height'];  ?>"/></td>
						<td><input class='form-control'  type='text' id='logoFontSize' value="<?php echo $styles['logo']['fontSize'];  ?>"/></td>
	...
	<script>
		$(function(){
				...
				$(this).addClass('draggable').parents().on('mousemove', function(e) {
					$('.draggable').offset({
						...
						if(targetid == 'date'){
							...
							updateLogo(dposition.top,dposition.left);
			...
			$('#logoTop,#logoLeft,#logoHeight,#logoWidth,#logoFontSize').keyup(function(){
				var t = $('#logoTop').val();
				var l = $('#logoLeft').val();
				var h = $('#logoHeight').val();
				var w = $('#logoWidth').val();
				var fs = $('#logoFontSize').val();

				changeHW(h,w,'logo');
				changePosition(t,l,'logo');
				changeFontSize(fs,'logo');
			...
			$('#logoVisible').change(function(){
				changeVisibility($(this).is(":checked"),'logo');
			});
			$('#logoBold').change(function(){
				changeBold($(this).is(":checked"),'logo');
			});
			...
			$('#lblVisible').change(function(){
				changeVisibility($(this).is(":checked"),'lbl');
			});
			$('#lblBold').change(function(){
				changeBold($(this).is(":checked"),'lbl');
			});
			...
			$('#save').click(function(){
				...
				var allstyle = {
					...
					logo: {
						visible: $('#logoVisible').is(':checked'),
						bold: $('#logoBold').is(':checked'),
						top : $('#logoTop').val(),
						left : $('#logoLeft').val(),
						height : $('#logoHeight').val(),
						width:$('#logoWidth').val(),
						fontSize:$('#logoFontSize').val()
					},
					membername: {
				...
				$.ajax({
					...
					success: function(data){
						alertify.alert(data,function(){
							location.href ='supplier_form_generator.php';
						});
					},
					error:function(){
			...
			function Popup(data)
			{
				...
				mywindow.document.write('<html><head><title></title><style>.conpage{width: 816px;height: 1056px;float:left;position:relative;border: 1px solid #000;}.date{position:absolute;top:<?php echo $styles['date']['top'] . "px" ?>;left:<?php echo $styles['date']['left'] . "px" ?>;width: <?php echo $styles['date']['width'] . "px" ?>;height: <?php echo $styles['date']['height'] . "px" ?>;font-size: <?php echo $styles['date']['fontSize'] . "px" ?>;display: <?php echo ($styles['date']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['date']['bold']) ? 'bold' : 'normal' ?>;}.membername{position:absolute;top:<?php echo $styles['membername']['top'] . "px" ?>;left:<?php echo $styles['membername']['left'] . "px" ?>;width: <?php echo $styles['membername']['width'] . "px" ?>;height: <?php echo $styles['membername']['height'] . "px" ?>;font-size: <?php echo $styles['membername']['fontSize'] . "px" ?>;display: <?php echo ($styles['membername']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['membername']['bold']) ? 'bold' : 'normal' ?>;}.memberaddress{position:absolute;top:<?php echo $styles['memberaddress']['top'] . "px" ?>;left:<?php echo $styles['memberaddress']['left'] . "px" ?>;width: <?php echo $styles['memberaddress']['width'] . "px" ?>;height: <?php echo $styles['memberaddress']['height'] . "px" ?>;font-size: <?php echo $styles['memberaddress']['fontSize'] . "px" ?>;display: <?php echo ($styles['memberaddress']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['memberaddress']['bold']) ? 'bold' : 'normal' ?>;}.stationname{position:absolute;top:<?php echo $styles['stationname']['top'] . "px" ?>;left:<?php echo $styles['stationname']['left'] . "px" ?>;width: <?php echo $styles['stationname']['width'] . "px" ?>;height: <?php echo $styles['stationname']['height'] . "px" ?>;font-size: <?php echo $styles['stationname']['fontSize'] . "px" ?>;display: <?php echo ($styles['stationname']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['stationname']['bold']) ? 'bold' : 'normal' ?>;}.stationaddress{position:absolute;width: <?php echo $styles['stationaddress']['width'] . "px" ?>;height: <?php echo $styles['stationaddress']['height'] . "px" ?>;top:<?php echo $styles['stationaddress']['top'] . "px" ?>;left:<?php echo $styles['stationaddress']['left'] . "px" ?>;font-size: <?php echo $styles['stationaddress']['fontSize'] . "px" ?>;display: <?php echo ($styles['stationaddress']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['stationaddress']['bold']) ? 'bold' : 'normal' ?>;}table{font-size: <?php echo $styles['itemtable']['fontSize'] . "px" ?>;}.itemtable{position:absolute;top:<?php echo $styles['itemtable']['top'] . "px" ?>;left:<?php echo $styles['itemtable']['left'] . "px" ?>;width: <?php echo $styles['itemtable']['width'] . "px" ?>;height: <?php echo $styles['itemtable']['height'] . "px" ?>;font-size: <?php echo $styles['itemtable']['fontSize'] . "px" ?>;display: <?php echo ($styles['itemtable']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['itemtable']['bold']) ? 'bold' : 'normal' ?>;}.payments{position:absolute;top:<?php echo $styles['payments']['top'] . "px" ?>;left:<?php echo $styles['payments']['left'] . "px" ?>;width: <?php echo $styles['payments']['width'] . "px" ?>;height: <?php echo $styles['payments']['height'] . "px" ?>;font-size: <?php echo $styles['payments']['fontSize'] . "px" ?>;display: <?php echo ($styles['payments']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['payments']['bold']) ? 'bold' : 'normal' ?>;}.payments2{position:absolute;top:<?php echo $styles['payments2']['top'] . "px" ?>;left:<?php echo $styles['payments2']['left'] . "px" ?>;width: <?php echo $styles['payments2']['width'] . "px" ?>;height: <?php echo $styles['payments2']['height'] . "px" ?>;font-size: <?php echo $styles['payments2']['fontSize'] . "px" ?>;display: <?php echo ($styles['payments2']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['payments2']['bold']) ? 'bold' : 'normal' ?>;}.payments3{position:absolute;top:<?php echo $styles['payments3']['top'] . "px" ?>;left:<?php echo $styles['payments3']['left'] . "px" ?>;width: <?php echo $styles['payments3']['width'] . "px" ?>;height: <?php echo $styles['payments3']['height'] . "px" ?>;font-size: <?php echo $styles['payments3']['fontSize'] . "px" ?>;display: <?php echo ($styles['payments3']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['payments3']['bold']) ? 'bold' : 'normal' ?>;}.cashier{position:absolute;top:<?php echo $styles['cashier']['top'] . "px" ?>;left:<?php echo $styles['cashier']['left'] . "px" ?>;width: <?php echo $styles['cashier']['width'] . "px" ?>;height: <?php echo $styles['cashier']['height'] . "px" ?>;font-size: <?php echo $styles['cashier']['fontSize'] . "px" ?>;display: <?php echo ($styles['cashier']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['cashier']['bold']) ? 'bold' : 'normal' ?>;}.remarks{position:absolute;top:<?php echo $styles['remarks']['top'] . "px" ?>;left:<?php echo $styles['remarks']['left'] . "px" ?>;width: <?php echo $styles['remarks']['width'] . "px" ?>;height: <?php echo $styles['remarks']['height'] . "px" ?>;font-size: <?php echo $styles['remarks']['fontSize'] . "px" ?>;display: <?php echo ($styles['remarks']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['remarks']['bold']) ? 'bold' : 'normal' ?>;}.reserved{position:absolute;top:<?php echo $styles['reserved']['top'] . "px" ?>;left:<?php echo $styles['reserved']['left'] . "px" ?>;width: <?php echo $styles['reserved']['width'] . "px" ?>;height: <?php echo $styles['reserved']['height'] . "px" ?>;font-size: <?php echo $styles['reserved']['fontSize'] . "px" ?>;display: <?php echo ($styles['reserved']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['reserved']['bold']) ? 'bold' : 'normal' ?>;}.drnum{position:absolute;top:<?php echo $styles['drnum']['top'] . "px" ?>;left:<?php echo $styles['drnum']['left'] . "px" ?>;width: <?php echo $styles['drnum']['width'] . "px" ?>;height: <?php echo $styles['drnum']['height'] . "px" ?>;font-size: <?php echo $styles['drnum']['fontSize'] . "px" ?>;display: <?php echo ($styles['drnum']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['drnum']['bold']) ? 'bold' : 'normal' ?>;}.terms{position:absolute;top:<?php echo $styles['terms']['top'] . "px" ?>;left:<?php echo $styles['terms']['left'] . "px" ?>;width: <?php echo $styles['terms']['width'] . "px" ?>;height: <?php echo $styles['terms']['height'] . "px" ?>;font-size: <?php echo $styles['terms']['fontSize'] . "px" ?>;display: <?php echo ($styles['terms']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['terms']['bold']) ? 'bold' : 'normal' ?>;}.ponum{position:absolute;top:<?php echo $styles['ponum']['top'] . "px" ?>;left:<?php echo $styles['ponum']['left'] . "px" ?>;width: <?php echo $styles['ponum']['width'] . "px" ?>;height: <?php echo $styles['ponum']['height'] . "px" ?>;font-size: <?php echo $styles['ponum']['fontSize'] . "px" ?>;display: <?php echo ($styles['ponum']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['ponum']['bold']) ? 'bold' : 'normal' ?>;}.tin{position:absolute;top:<?php echo $styles['tin']['top'] . "px" ?>;left:<?php echo $styles['tin']['left'] . "px" ?>;width: <?php echo $styles['tin']['width'] . "px" ?>;height: <?php echo $styles['tin']['height'] . "px" ?>;font-size: <?php echo $styles['tin']['fontSize'] . "px" ?>;display: <?php echo ($styles['tin']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['tin']['bold']) ? 'bold' : 'normal' ?>;}.draggable{background-color:#999;cursor:move;}.tdbarcode{position:relative;width: <?php echo $styles['tdbarcode']['width'] . "px" ?>;padding-left: <?php echo $styles['tdbarcode']['left'] . "px" ?>;display: <?php echo ($styles['tdbarcode']['visible']) ? 'inline-block' : 'none' ?>;font-weight: <?php echo ($styles['tdbarcode']['bold']) ? 'bold' : 'normal' ?>;}.tdqty{position:relative;width: <?php echo $styles['tdqty']['width'] . "px" ?>;padding-left: <?php echo $styles['tdqty']['left'] . "px" ?>;display: <?php echo ($styles['tdqty']['visible']) ? 'inline-block' : 'none' ?>;font-weight: <?php echo ($styles['tdqty']['bold']) ? 'bold' : 'normal' ?>;}.tddescription{position:relative;width: <?php echo $styles['tddescription']['width'] . "px" ?>;padding-left: <?php echo $styles['tddescription']['left'] . "px" ?>;display: <?php echo ($styles['tddescription']['visible']) ? 'inline-block' : 'none' ?>;font-weight: <?php echo ($styles['tddescription']['bold']) ? 'bold' : 'normal' ?>;}.tdprice{position:relative;width: <?php echo $styles['tdprice']['width'] . "px" ?>;padding-left: <?php echo $styles['tdprice']['left'] . "px" ?>;display: <?php echo ($styles['tdprice']['visible']) ? 'inline-block' : 'none' ?>;font-weight: <?php echo ($styles['tdprice']['bold']) ? 'bold' : 'normal' ?>;}.tdtotal{position:relative;width: <?php echo $styles['tdtotal']['width'] . "px" ?>;padding-left: <?php echo $styles['tdtotal']['left'] . "px" ?>;display: <?php echo ($styles['tdtotal']['visible']) ? 'inline-block' : 'none' ?>;font-weight: <?php echo ($styles['tdtotal']['bold']) ? 'bold' : 'normal' ?>;}.lbl2{position:absolute;top:<?php echo $styles['lbl2']['top'] . "px" ?>;left:<?php echo $styles['lbl2']['left'] . "px" ?>;width: <?php echo $styles['lbl2']['width'] . "px" ?>;height: <?php echo $styles['lbl2']['height'] . "px" ?>;font-size: <?php echo $styles['lbl2']['fontSize'] . "px" ?>;display: <?php echo ($styles['lbl2']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['lbl2']['bold']) ? 'bold' : 'normal' ?>;}.lbl{position:absolute;top:<?php echo $styles['lbl']['top'] . "px" ?>;left:<?php echo $styles['lbl']['left'] . "px" ?>;width: <?php echo $styles['lbl']['width'] . "px" ?>;height: <?php echo $styles['lbl']['height'] . "px" ?>;font-size: <?php echo $styles['lbl']['fontSize'] . "px" ?>;display: <?php echo ($styles['lbl']['visible']) ? 'block' : 'none' ?>;font-weight: <?php echo ($styles['lbl']['bold']) ? 'bold' : 'normal' ?>;}</style>');

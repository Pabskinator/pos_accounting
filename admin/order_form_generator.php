		...
		<div class="page-content inset">
			...
			<div id="content" >
				<div id='conpage' data-targetid='conpageValue' class="conpage">
					...
					<div data-targetid='membername' class='membername canbedrag'>Branch From</div> <!-- Member -->
					<div data-targetid='memberaddress' class='memberaddress canbedrag'>Branch From Address</div><!-- Member -->
					<div data-targetid='stationname' class='stationname canbedrag'>Branch To</div><!-- station -->
					<div data-targetid='stationaddress' class='stationaddress canbedrag'>Branch To Address</div><!-- station -->
					...
					<div data-targetid='cashier' class='cashier canbedrag'>Release by</div><!-- cashier by -->
					<div data-targetid='remarks' class='remarks canbedrag'>Approved by</div><!-- Remarks -->
					<div data-targetid='reserved' class='reserved canbedrag'>Received by</div><!-- resered by -->
					<div data-targetid='drnum' class='drnum canbedrag'>Ctrl #</div><!-- dr num -->
				...
				$.ajax({
					...
					success: function(data){
						alertify.alert(data,function(){
							location.href ='order_form_generator.php';
						});
					},
					error:function(){

	...
	<div class="page-content inset">
		<div class="content-header">
			<h1>
				...
				<span class='txtCurrent'></span> Summary
			</h1>
		...
		$(document).ready(function(){
			...
			function getRecord(t){
				...
				$.ajax({
					...
					type:'POST',
					data: {functionName:'getCustomRecordSummary',branch_id:JSON.stringify(branch_id),query_string: default_val,t:t,dt_from:dt_from,dt_to:dt_to,sales_type:sales_type},
			...
			function downloadRecord(){
				...
				var sales_type = $('#sales_type').val();
				window.open(
					'../ajax/ajax_sales_query.php?functionName=getCustomRecordSummary&dt_from='+dt_from+'&dt_to='+dt_to+'&sales_type='+sales_type+'&t=1'+'&query_string='+default_val,

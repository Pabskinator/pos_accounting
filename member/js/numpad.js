...
(function($){
  ...
  */
  ...
  $.fn.numpad.defaults = {
    ...
    gridTpl: '<div class="grey lighten-2 z-depth-2"><table ></table></div>',
    displayTpl: '<input type="text" />',
    displayCellTpl: '<td colspan="4"></td>',
    rowTpl: '<tr></tr>',
    cellTpl: '<td></td>',
    buttonNumberTpl: '<button class="waves-effect waves-light btn grey darken-2 btn_num"></button>',
    buttonFunctionTpl: '<button class="waves-effect waves-light btn grey darken-2 btn_action"></button>',
    gridTableClass: '',

...
(function($){
	...
	$.fn.numpad.defaults = {
		target: false,
		openOnEvent: 'click',
		backgroundTpl: '<div class="white"></div>',
		gridTpl: '<table class="grey lighten-3"></table>',
		displayTpl: '<input type="text" />',
		displayCellTpl: '<td colspan="4"></td>',
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
		buttonNumberTpl: '<button class="btn black"></button>',
		buttonFunctionTpl: '<button class="btn black btn-fix"></button>',
		gridTableClass: '',
